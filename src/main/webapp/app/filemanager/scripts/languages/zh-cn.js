{
    ...
    "ERROR_CREATING_ZIP": "创建 Zip 文件发生错误", 
    "ERROR_OPENING_FILE": "打开文件发生错误.", 
    ...
    "ERROR_SAVING_FILE": "保存文件发生错误.", 
    "ERROR_UPLOADING_FILE": "上传文件发生错误.", 
    "ERROR_WRITING_PERM": "你对该文件没有写权限.", 
    ...
    "dimensions": "尺寸", 
    "download": "下载", 
    "dz_dictDefaultMessage": "拖放文件到这里上传", 
    "dz_dictFallbackMessage": "你的浏览器不支持 drag'n'drop 文件上传.", 
    "dz_dictInvalidFileType": "你不能上传该类型文件.", 
    "dz_dictMaxFilesExceeded": "只允许同时上传%s个文件.", 
    "edit": "编辑文件", 
    "fck_select_integration": "'选择'功能只用于集成FCKeditor的。", 
    "file_size_limit": "文件大小限制为 : ", 
    "file_too_big": "文件太大了.", 
    "gb": "gb", 
    "gotoroot": "根文件夹", 
    "grid_view": "切换到网格视图.", 
