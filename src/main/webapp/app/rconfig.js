var require = {
    waitSeconds: 0,
    paths: {
    	'angular-shiro': '../plugin/angular-shiro/angular-shiro',
    	'jquery-treetable': '../plugin/jquery-treetable/jquery.treetable',
    	'datatables-treetable': '../plugin/datatables-treetable/datatables.treetable',
    	'angular-hierarchical-selector': '../plugin/angular-hierarchical-selector/hierarchical-selector',
    	'angular-tree-item': '../plugin/angular-hierarchical-selector/tree-item',
    	'angular-selector-utils': '../plugin/angular-hierarchical-selector/selector-utils',
    	'contextmenu': '../plugin/jquery-contextmenu/jquery.contextmenu',
    	'integralui': '../plugin/angular-intergralui/angular.integralui.min',
    	'integralui-lists': '../plugin/angular-intergralui/angular.integralui.lists.min',
    	'integralui-treeview': '../plugin/angular-intergralui/angular.integralui.treeview.min',
        ...
        'jquery-validation.messages_cn' : '../plugin/jquery-validation/jquery.validate.messages_cn',
        ...
        'lodash-deep': '../plugin/lodash/dist/lodash-deep.min',
    ...
    shim: {
    	'angular-shiro' : {deps: ['angular-ui-router']},
    	'datatables-treetable': {deps: ['datatables','jquery-treetable']},
    	'angular-hierarchical-selector' : {deps: ['angular','angular-tree-item','angular-selector-utils']},
    	'angular-tree-item' : {deps: ['angular']},
    	'angular-selector-utils' : {deps: ['angular']},
    	'lodash-deep': {deps: ['lodash']},
    	'contextmenu': {deps: ['angular']},
    	'integralui': {deps: ['angular']},
    	'integralui-lists': {deps: ['angular','integralui']},
    	'integralui-treeview': {deps: ['angular','integralui','integralui-lists']},
    	'sockjs': {deps: ['angular']},
