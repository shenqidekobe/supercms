...
@Service
public class PraiseTopDirective extends BaseDirective{
	...
	public void execute(Environment env, Map params, TemplateModel[] models,
		...
		try {
			...
			String desc=String.format("点赞排行榜指令解析错误,params=%s", params);
	...
	public List<TopData> getList(Environment env,Map params) throws TemplateModelException {
		...
		return this.praiseService.findPraisesByTop(siteId, columnId,isOrgan,topNum, pager);
	}
